...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //get the POST ID for thenewly created post 

        // upload the image to firebase stroge with upolad to orignal post
        
        // get a download URL from fb stroage and update the orginal post with image
